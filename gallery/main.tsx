...
import answersYearEnd from "../fixtures/answers-year-end.json";
import {
  AnswerPicture,
  Dashboard,
  LOCALE_NAMES,
...
const ANSWERS = { tight: answersTight, overdrawn: answersOverdrawn, yearEnd: answersYearEnd } as unknown as Record<string, Record<Locale, Answers>>;
const FIXTURES: Record<string, Snapshot> = { demo: demo as Snapshot, tight: tight as Snapshot, empty: empty as Snapshot };

const UI = {
  fr: { answers: "Réponses", "household.tight": "Mois serré", "household.overdrawn": "À découvert", "household.yearEnd": "Fin d’année", answersIntro: "Chaque réponse a son dessin : les chiffres et la légende viennent du moteur, le kit ne fait que dessiner. Le même code dessine sur bazous.com, dans Claude et dans ChatGPT.", title: "Galerie des modules", intro: "Chaque carte répond à une question d’argent. Toutes les données sont fictives ; rien ne quitte cette page.", cockpit: "Cockpit", modules: "Modules", data: "Données", reads: "Lit", log: "Intentions émises", logEmpty: "Cliquez un bouton : l’intention apparaît ici au lieu d’être envoyée.", source: "Code source" },
  de: { answers: "Antworten", "household.tight": "Knapper Monat", "household.overdrawn": "Im Minus", "household.yearEnd": "Jahresende", answersIntro: "Jede Antwort hat ihr Bild: Zahlen und Bildlegende kommen vom Rechenkern, das Kit zeichnet nur. Derselbe Code zeichnet auf bazous.com, in Claude und in ChatGPT.", title: "Modulgalerie", intro: "Jede Karte beantwortet eine Geldfrage. Alle Daten sind fiktiv; nichts verlässt diese Seite.", cockpit: "Cockpit", modules: "Module", data: "Daten", reads: "Liest", log: "Ausgelöste Absichten", logEmpty: "Klicken Sie eine Schaltfläche: die Absicht erscheint hier, statt gesendet zu werden.", source: "Quellcode" },
  it: { answers: "Risposte", "household.tight": "Mese stretto", "household.overdrawn": "In rosso", "household.yearEnd": "Fine anno", answersIntro: "Ogni risposta ha il suo disegno: cifre e didascalia vengono dal motore, il kit disegna soltanto. Lo stesso codice disegna su bazous.com, in Claude e in ChatGPT.", title: "Galleria dei moduli", intro: "Ogni scheda risponde a una domanda sul denaro. Tutti i dati sono fittizi; nulla lascia questa pagina.", cockpit: "Cockpit", modules: "Moduli", data: "Dati", reads: "Legge", log: "Intenzioni emesse", logEmpty: "Clicca un pulsante: l’intenzione appare qui invece di essere inviata.", source: "Codice sorgente" },
  rm: { answers: "Respostas", "household.tight": "Mais stretg", "household.overdrawn": "En il minus", "household.yearEnd": "Fin da l’onn", answersIntro: "Mintga resposta ha ses dissegn: las cifras e la legenda vegnan dal motor, il kit dissegna mo. Il medem code dissegna sin bazous.com, en Claude ed en ChatGPT.", title: "Galaria dals moduls", intro: "Mintga carta respunda ina dumonda da daners. Tut las datas èn fictivas; nagut na banduna questa pagina.", cockpit: "Cockpit", modules: "Moduls", data: "Datas", reads: "Legia", log: "Intenziuns emessas", logEmpty: "Cliccai in buttun: l’intenziun cumpara qua empè da vegnir tramessa.", source: "Code da funtauna" },
  en: { answers: "Answers", "household.tight": "Tight month", "household.overdrawn": "Overdrawn", "household.yearEnd": "Year end", answersIntro: "Each answer has its picture: the figures and the caption come from the engine, the kit only draws. The same code draws on bazous.com, in Claude and in ChatGPT.", title: "Module gallery", intro: "Each card answers one money question. All data is fictitious; nothing leaves this page.", cockpit: "Cockpit", modules: "Modules", data: "Data", reads: "Reads", log: "Emitted intents", logEmpty: "Click a button: the intent shows up here instead of being sent.", source: "Source code" },
